...
# Created by write_sdc on Sun Dec 24 12:27:24 2023

###################################################################
set sdc_version 2.1

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current mA
set_load -pin_load 10 [get_ports isZeroOut]
...
isZeroA] [get_ports {B[31]}] [get_ports {B[30]}] [get_ports {B[29]}]           \
...
isZeroB]]
set_false_path -hold   -to [list [get_ports isZeroOut] [get_ports {product[31]}] [get_ports          \
{product[30]}] [get_ports {product[29]}] [get_ports {product[28]}] [get_ports  \
{product[27]}] [get_ports {product[26]}] [get_ports {product[25]}] [get_ports  \
{product[24]}] [get_ports {product[23]}] [get_ports {product[22]}] [get_ports  \
{product[21]}] [get_ports {product[20]}] [get_ports {product[19]}] [get_ports  \
{product[18]}] [get_ports {product[17]}] [get_ports {product[16]}] [get_ports  \
{product[15]}] [get_ports {product[14]}] [get_ports {product[13]}] [get_ports  \
{product[12]}] [get_ports {product[11]}] [get_ports {product[10]}] [get_ports  \
{product[9]}] [get_ports {product[8]}] [get_ports {product[7]}] [get_ports     \
{product[6]}] [get_ports {product[5]}] [get_ports {product[4]}] [get_ports     \
{product[3]}] [get_ports {product[2]}] [get_ports {product[1]}] [get_ports     \
{product[0]}]]
...
set_input_delay -clock clk  -max 0.2  [get_ports isZeroA]
...
set_input_delay -clock clk  -max 0.2  [get_ports isZeroB]
set_output_delay -clock clk  -max 0.5  [get_ports isZeroOut]
